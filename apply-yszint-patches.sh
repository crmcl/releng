...
echo "         mkdir -p build/android-arm64"
echo "         ln -sf ../frida-android-arm64.txt build/android-arm64/frida-android-arm64.txt"
echo "         make -C subprojects/frida-core/src/linux/helpers build-native \\"
echo "             FRIDA_HOST=android-arm64 BUILDDIR=\$PWD/build \\"
echo "             MESON=\$PWD/releng/meson/meson.py"
